...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        heading.setFont(new Font("Georgia", Font.PLAIN, 32));
        add(heading);
        
        JLabel subheading = new JLabel("Boarding Pass");
        subheading.setBounds(360, 50, 300, 30);
        subheading.setFont(new Font("Georgia", Font.PLAIN, 24));
        subheading.setForeground(Color.black);
        add(subheading);
        
        JLabel lblaadhar = new JLabel("PNR DETAILS");
        lblaadhar.setBounds(60, 100, 150, 25);
        lblaadhar.setFont(new Font("Georgia", Font.PLAIN, 16));
        add(lblaadhar);
        ...
        lblnationality.setFont(new Font("Georgia", Font.PLAIN, 16));
        add(lblnationality);
        ...
        lblgender.setFont(new Font("Georgia", Font.PLAIN, 16));
        add(lblgender);
        ...
        lblfname.setFont(new Font("Georgia", Font.PLAIN, 16));
        add(lblfname);
        ...
        lblfcode.setFont(new Font("Georgia", Font.PLAIN, 16));
        add(lblfcode);
        ...
        lbldate.setFont(new Font("Georgia", Font.PLAIN, 16));
        add(lbldate);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagemantsystem/icons/airindia.png"));
...
//        imageIcon image1 = new imageIcon(ClassLoader.getSystemResource("airlinemanagemantsystem/icons/barcode.png"));
//        JLabel blimage = new JLabel((Icon) image1);
//        blimage.setBounds(450, 80, 280, 400);
//        add(blimage);
//        
        setSize(1000, 450);
        setLocation(300, 150);
