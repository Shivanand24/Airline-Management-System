...
insert into flight values("1002", "AI-1453", "lucknow", "Goa");
insert into flight values("1003", "AI-1112", "Mumbai", "Chennai");
insert into flight values("1004", "AI-3222", "patna", "Amritsar");
insert into flight values("1005", "AI-1212", "Delhi", "Ayodhya");
select * from flight;
 delete from flight where f_code ="1005";
...
delete from name where name ="johny sins";